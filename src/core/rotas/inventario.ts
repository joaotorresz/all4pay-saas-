...
export const INVENTARIO: RotaInventario[] = [
  ...
  { rota: "/cadastros", nome: "Cadastros", dono: "cadastros", status: "aposentando", aposentadoriaEm: "2026-10-01" },
  ...
  { rota: "/copiloto", nome: "Copiloto e motores", dono: "inteligencia", status: "aposentando", aposentadoriaEm: "2026-10-01" },
  ...
  { rota: "/dashboard/registrations/products", nome: "Produtos", dono: "cadastros", status: "canonica" },
  ...
  { rota: "/dre", nome: "DRE (versão anterior)", dono: "relatorios", status: "aposentando", aposentadoriaEm: "2026-10-01" },
  ...
  { rota: "/impostos", nome: "Impostos (projeção)", dono: "fiscal", status: "aposentando", aposentadoriaEm: "2026-10-01" },
  ...
  { rota: "/pagamentos", nome: "Extrato de pagamentos", dono: "movimentacoes", status: "aposentando", aposentadoriaEm: "2026-10-01" },
  ...
  { rota: "/recebimentos", nome: "Extrato de recebimentos", dono: "movimentacoes", status: "aposentando", aposentadoriaEm: "2026-10-01" },
