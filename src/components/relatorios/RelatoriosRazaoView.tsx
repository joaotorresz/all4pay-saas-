      ...
      <div className="flex flex-col gap-5 pb-4">
        ...
        {entries === null ? (
          ...
          <Card className="flex flex-col items-start gap-2">
            ...
            <span className="text-caption text-muted">Faça o <b className="text-ink font-medium">Backfill do histórico</b> no Razão para gerar os lançamentos — os relatórios são calculados a partir deles.</span>
...
function Resumo({ label, valor, tone = "var(--color-ink)" }: { label: string; valor: number; tone?: string }) {
  return (
    <div className="flex flex-col gap-1">
