...
const ROUTES: RouteItem[] = [
  ...
  { label: "Títulos a receber", href: "/contas-a-receber/titulos", icon: "arrow-left-right", kw: "contas a receber titulos lista recebidas atrasadas cliente vencimento baixa lote dash painel inadimplencia a vencer periodo" },
  { label: "Títulos a pagar", href: "/contas-a-pagar/titulos", icon: "arrow-up-right", kw: "contas a pagar titulos lista pagas atrasadas fornecedor vencimento baixa lote especie dash painel a vencer periodo" },
  { label: "Transferências entre contas", href: "/dashboard/financial/accounts-and-transfers", icon: "arrow-left-right", kw: "transferencia entre contas origem destino ted doc chegada conciliacao" },
